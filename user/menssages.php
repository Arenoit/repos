...
?>
        <div class="home-content">
            <?php if(!empty($chat)&&$chat!=$_SESSION['codusr']){ 
                $confChat="SELECT users_usr_users,users_usr_users,users_sts_users,users_img_users,users_typ_users FROM acausers WHERE users_cod_users='$_GET[chat]'";
                ...
                if(!empty($configChat['users_usr_users'])&&$configChat['users_typ_users']==0){
            ?>
