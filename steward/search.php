            ...
            <div class="home-content">
                ...
                ?>
                            ...
                            <form action="./search" method="GET" id="filform">
                                ...
                                <label>Filtros:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <div style="display:flex;padding-bottom:9px">
                                        <select name="selecciones" id="selecciones" class="custom-select form-control form-control-sm">
                                            <?php
                    ...
                    <div class="options-project" style="display:flex;justify-content: space-between;">
                        ...
                        <a class="btn btn-success" href="./insertion">Agregar Nuevo</a>
                    </div>
                    <table class="table-striped table-bordered dataTable no-footer" style="width: 100%;">
                        <thead class="sorting" style="background: #251b1b;color: white;">
                            ...
                            <th tabindex="0" rowspan="1" colspan="1" style="width: 321px;">Titulo</th>
                            <th tabindex="0" rowspan="1" colspan="1" style="width: 172px;">Autor(es)</th>
                        ...
                        <?php
                            ...
                            foreach($resultOptions as $libreria){
                                $metadatos=explode(",",$libreria['metadatos']);
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br>
                                    <?php for ($i=0; $i < count($metadatos); $i++){if(!empty($metadatos[$i]))echo "<span>$metadatos[$i]</span>";}?>
                                </td>
                                ...
                                <td>
                                    <a class='btn btn-success' href='./update?id=<?=$libreria['projc_cod_projc']?>'><i class="fa-solid fa-pencil"></i></a>
                                    <a class='btn btn-danger' name="delete" direction='id=<?=$libreria['projc_cod_projc']?>' href='#'><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php
                            $registros++;
                    ...
                    ?>
                        <div class="panel-primary browser">
                            ...
                            ?>
                                <ul>
                                    <li><a href="./search?assortment&collec=<?=$colecciones['colec_nom_colec'];?>"><?=$colecciones['colec_nom_colec'];?></a> <span><?=$colecciones['reg'];?></span> <a class="btn btn-success" name="edit" direction="<?=$colecciones['colec_nom_colec'];?>"><i class="fa-solid fa-pencil"></i></a></li>
                                </ul>
                            <?php
                                }
                                echo '</div><script src="../js/collections.js"></script>';
                            }
